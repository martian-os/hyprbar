...
bool WaylandManager::create_bar_surface(BarPosition position, uint32_t width,
                                        uint32_t height) {
...
void WaylandManager::configure_layer_surface(BarPosition position,
...
wl_buffer *WaylandManager::create_buffer(size_t size, void **data) {
  ...
  Logger::instance().debug("Created wl_buffer: {} bytes ({}x{}, stride={})",
